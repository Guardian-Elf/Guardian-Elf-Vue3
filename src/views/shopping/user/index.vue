<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['shopping:user:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['shopping:user:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="账户状态" align="center" prop="isActive" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['shopping:user:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['shopping:user:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="userRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="账户状态" prop="isActive">
          <el-input v-model="form.isActive" placeholder="请输入账户状态" />
        </el-form-item>
        <el-form-item label="最后登录时间" prop="lastLogin">
          <el-date-picker clearable
...
import { listUser, getUser, delUser, addUser, updateUser } from "@/api/shopping/user"
...
function handleExport() {
  proxy.download('shopping/user/export', {
    ...queryParams.value
